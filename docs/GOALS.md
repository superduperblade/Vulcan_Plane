...
- World-coordinate model (tile/cell addressing, spatial partitioning) —
  done (step 3: geodetic quadtree `cells`, decision 0002)
- Basic world representation — done (step 4: `vp_world` resident-cell trie
  + content slots, decision 0003)
- Terrain representation — next
